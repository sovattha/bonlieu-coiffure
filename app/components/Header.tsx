...
export function Header(props: { content?: WelcomeMessageType['content']; message?: WelcomeMessageType['message']; minimalHeader?: boolean }) {
    return <header id={props.minimalHeader ? 'mentions-legales' : 'home'}>
